	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'desc'     => __( 'To unlock more amazing Testimonial Layouts (Grid, Masonry, List, & Isotope), <a target="_blank" href="https://shapedplugin.com/real-testimonials/pricing/?ref=1"><b>Upgrade To Pro!</b></a>.', 'testimonial-free' ),
	...
	array(
		...
		'fields' => array(
			array(
				...
				'desc'     => __( 'Get Access to 9 Professionally Designed Testimonial Themes with Customization options, <a target="_blank" href="https://shapedplugin.com/real-testimonials/pricing/?ref=1"><b>Upgrade to Pro!</b></a>', 'testimonial-free' ),
				'sanitize' => 'sanitize_text_field',
				'options'  => array(
					'theme-one'   => array(
			...
			array(
				'type'    => 'notice',
				'content' => __( 'To unlock the Theme based Customization options, <a target="_blank" href="https://shapedplugin.com/real-testimonials/pricing/?ref=1"><b>Upgrade to Pro!</b></a>.', 'testimonial-free' ),
			),
		),
	)
);
	...
	array(
		...
		'fields' => array(
			...
			array(
				'type'    => 'notice',
				'style'   => 'info',
				'content' => __( 'To unlock the following pagination settings for Grid, Masonry, & List layouts,<a target="_blank" href="https://shapedplugin.com/real-testimonials/pricing/?ref=1"><b> Upgrade To Pro!</b></a>', 'testimonial-free' ),
			),
			array(
				'id'         => 'grid_pagination',
				'type'       => 'switcher',
	...
	array(
		...
		'fields' => array(
			array(
				'type'    => 'notice',
				'style'   => 'normal',
				'content' => __( 'To unlock These Typography (940+ Google Fonts) options, <a target="_blank" href="https://shapedplugin.com/real-testimonials/pricing/?ref=1"><b>Upgrade to Pro!</b></a> P.S. Note: The color fields work in the lite version.', 'testimonial-free' ),
			),
			array(
...
SPFTESTIMONIAL::createSection(
	...
	array(
		...
		'fields' => array(
			...
			array(
				'type'    => 'notice',
				'content' => __( 'To unlock the following extra reviewer information fields, <a target="_blank" href="https://shapedplugin.com/real-testimonials/pricing/?ref=1"><b>Upgrade to Pro!</b></a>', 'testimonial-free' ),
			),
			array(
				'id'         => 'tpro_email',
				'class'      => 'pro_only_field',
