...
class TestimonialFree {
	...
	public function add_plugin_action_links( $links, $file ) {
		...
		if ( SP_TFREE_BASENAME === $file ) {
			...
			$links['go_pro'] = sprintf( '<a href="%s" style="%s">%s</a>', 'https://shapedplugin.com/real-testimonials/pricing/?ref=1', 'color:#35b747;font-weight:bold', __( 'Go Pro!', 'testimonial-free' ) );
